...
export function GitHubSignButton ({ children, onClick }: SignButtonProps) {
  return (
    <button type="button" onClick={onClick} className="text-[#0e1419] bg-white hover:bg-[#e6e6e6] focus:ring-4 focus:outline-none focus:ring-[#24292F]/50 font-bold rounded-full text-sm py-[9px] text-center flex items-center justify-center w-[300px] border-[#dce4e7] border-[1px]">
...
export function GoogleSignButton ({ children, onClick }: SignButtonProps) {
  return (
    <button type="button" onClick={onClick} className="text-[#0e1419] bg-white hover:bg-[#e6e6e6] focus:ring-4 focus:outline-none focus:ring-[#24292F]/50 font-semibold rounded-full text-sm py-[9px] text-center flex items-center justify-center w-[300px] border-[#dce4e7] border-[1px]">
...
export function RegularSignUpButton ({ children, onClick }: SignButtonProps) {
  return (
    <button type="button" onClick={onClick} className="text-white bg-[#009aec] hover:bg-[#0089cf] focus:ring-4 focus:outline-none focus:ring-[#24292F]/50 font-bold rounded-full text-sm py-[10px] text-center flex items-center justify-center w-[300px]">
      <span>{children}</span>
    </button>
  )
}
