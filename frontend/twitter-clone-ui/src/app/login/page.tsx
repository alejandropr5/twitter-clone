...
export default function Login () {
  return (
    <main className="flex flex-col min-h-screen h-full w-screen dark:bg-black bg-white items-center">
      <div className="max-lg:p-4 w-fit">
        <div className="max-lg:p-5 flex">
        <div className="flex flex-col lg:flex-row grow items-center">
          <div className="flex h-fit lg:grow place-self-start">
            <svg className="pb-3 lg:p-8 lg:grow min-h-[45px] min-w-[45px] lg:max-h-[444px]" fill="currentColor" viewBox="0 0 24 24">
          ...
          <div className="lg:p-4 flex items-center">
            <div className="lg:p-5">
              <div className="lg:w-[720px] max-w-[720px]">
                  <h1 className="text-7xl my-12 font-login text-[40px] min-[500px]:text-[48pt] text-[#0e1419] dark:text-[#e7e9ea]">
                    Happening now
                  </h1>
              </div>
              <div>
                <h2 className="text-4xl mb-5 lg:mb-8 font-login text-[23px] min-[500px]:text-[23.5pt] text-[#0e1419] dark:text-[#e7e9ea]">
                  Join today
                </h2>
              </div>
              <div>
